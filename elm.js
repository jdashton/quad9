...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var randomInt = function (seed) {    return $Random.generate(A2($Random.$int,1,10))(seed);};
   var update = F2(function (_p1,_p0) {
      var _p2 = _p1;
      var _p3 = _p0;
      var _p4 = randomInt(_p3._0);
      var num = _p4._0;
      var seed$ = _p4._1;
      return {ctor: "_Tuple2",_0: seed$,_1: {ctor: "_Tuple2",_0: _p2._0 - _p3._1._0 - num,_1: _p3._1._1 - _p2._1 + num}};
   });
   ...
   A3($Signal.foldp,update,{ctor: "_Tuple2",_0: startTimeSeed,_1: {ctor: "_Tuple2",_0: 0,_1: 0}},$Mouse.position));
   return _elm.Main.values = {_op: _op,randomInt: randomInt,startTimeSeed: startTimeSeed,update: update,main: main};
};
